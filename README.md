...
## 주요 기능 📦
### ⭐ 약품 정보 검색 기능
* **성분 또는 약품 검색**: 사용자가 성분 또는 약품명을 검색하면 관련된 약품 목록을 리스트 형식으로 제공

* **약품 정보 제공**: 리스트에는 주성분, 효능, 사용법 등이 간략히 표시되며 약품을 클릭하면 부작용, 약물-음식 상호작용 등 세부 정보를 확인 가능

### ⭐ 약품 관리 기능
* **약품 정보 및 유효 기간 관리**: 사용자가 보유 중이거나 새로 구매한 약품 정보를 등록하고, 구입 날짜와 유효 기간을 입력하면 유효 기간 만료 7일 전 알림 서비스 제공

### ⭐ 증상 기반 필요 성분 및 약품 정보 제공
* **증상 검색**: 사용자가 증상을 검색하면 해당 증상에 대한 설명과 해결 방법을 제시

* **완화 성분 및 약품 추천**: 증상 완화에 도움이 되는 성분 정보를 제공하며, 적절한 약품을 추천

### ⭐ 건강 관련 뉴스 및 정보 열람
* **건강 정보 제공**: 건강에 유익한 뉴스 기사와 정보를 제공하여 사용자에게 최신 건강 정보를 전달
