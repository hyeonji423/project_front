...
---
## 화면 구성 🖥
| <span style="background-color: #f0f0f0; display:inline-block">메인 페이지</span>  |  <span style="background-color: #f0f0f0">증상 페이지</span>   |
| :-------------------------------------------: | :------------: |
...
| <span style="background-color: #f0f0f0">약품 페이지</span>   |  <span style="background-color: #f0f0f0">뉴스/정보 페이지</span>   |
