...
import cm080782142 from '../assets/CK_cm080782142.jpg';
...
const Muscle_pain = () => {
  ...
  return (<div>     
    ...
    <img src={cm080782142} alt="sickimg1" />
    <div className="ml-8 border border-black bg-yellow-400 w-[900px]">    
    <center><p className="mt-8 text-blue-900">#근육통 관련 질환</p><br/>
