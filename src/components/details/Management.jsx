          ...
          <div className="wrapper border border-gray-300 rounded-lg p-10 flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4" >
              <div className="form-item">
                ...
                <input type="text" placeholder="제품명을 입력해주세요." onChange={handleChange} name="mediName"/>
              </div>
              <div className="form-item">
                <label htmlFor="company_name">회사명</label>
                <input type="text" placeholder="제조회사를 입력해주세요." onChange={handleChange} name="companyName"/>
              </div>
              <div className="form-item">
              ...
              <div className="form-item">
                ...
                <input type="text" placeholder="대표증상을 입력해주세요." onChange={handleChange} name="mainSymptom"/>
              </div>
              <div className="form-item flex flex-col gap-2">
                <label htmlFor="memo">NOTE</label>
                <textarea rows="4" onChange={handleChange} name="memo"></textarea>
              </div>
