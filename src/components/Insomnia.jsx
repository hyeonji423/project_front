...
import tc01500000308 from '../assets/CK_tc01500000308.jpg';
...
const Insomnia = () => {
  ...
  return (<div>     
    ...
    <img src={tc01500000308} alt="sickimg1" />
    <div className="ml-8 border border-black bg-yellow-600 w-[900px]">    
    <center><p className="mt-8 text-blue-900">#불면증 관련 질환</p><br/>
