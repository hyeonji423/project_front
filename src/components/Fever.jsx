...
import cm08353676 from '../assets/CK_cm08353676.jpg';
...
const Fever = () => {
  ...
  return (<div>     
    ...
    <img src={cm08353676} alt="sickimg1" />
    <div className="ml-8 border border-black bg-orange-900 w-[900px]">    
    <center><p className="mt-8 text-blue-900">#미열 관련 질환</p><br/>
