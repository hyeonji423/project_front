...
import cb2000004996 from '../assets/CK_cb2000004996.jpg';
...
const Rush = () => {
  ...
  return (<div>     
    ...
    <img src={cb2000004996} alt="sickimg1" />
    <div className="ml-8 border border-black bg-orange-700 w-[900px]">    
    <center><p className="mt-8 text-blue-900">#피부발진 관련 질환</p><br/>
