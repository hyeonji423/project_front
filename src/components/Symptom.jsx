...
const Symptom = () => {
  ...
  return (<div>
    {/* Contact */}
    <center><h1><p className="public"><b>대표증상</b></p></h1></center>
    <div className="cmain">
    <img src='' alt="sickimg1" />
    <div class="symptoms">
    <center><p className="bodyaches">#감기&심한몸살 관련 질환</p><br/>
    ...
    <h4 className="text-2xl font-bold text-center mb-6 ml-[-40px]">&nbsp;추천&nbsp;<br/>약품</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {medicines.map((medicine) => (
            <div key={medicine.id} className="border p-4 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <p className="mt-2 text-red-500 text-sm">:경고: {medicine.caution}</p>
            </div>
          ))}
<p className="justify-center items-center relative">※항생제는 감기에 효과가 없으며, 의사의 처방 없이 복용하지 마세요!</p>
        </div>
        </div><br/>
        <div className="medilist mt-6 text-center text-sm text-gray-500">
          <p className="mt-[35px] text-base">약리스트&nbsp;<button>검색</button></p>
        </div><br/>
    </div>);
};
